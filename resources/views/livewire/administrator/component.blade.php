                    ...
                    <div class="card">
                        <div class="card-header bg-gradient-dark">
                            <h3 class="card-title">
                                ...
                                @else
                                    <span id="dynamicText{{$this->pageTitle}}">Administrators</span>
                                @endif
                            </h3>
                        </div>
                        <!-- /.card-header -->
                                                ...
                                                <div class="d-flex justify-content-between align-items-center mx-3" style="display: none;">
                                                    ...
                                                    <div class="d-flex flex-column text-right ml-2">
                                                        <span>
                                                            ...
                                                            @can('user_destroy')
                                                                <a href="javascript:void(0)"
                                                                    onclick="confirm('{{ $user->id }}', 'Are you sure you want delete this Item?', 'You won\'t be able to revert this!', 'Item', 'destroy')"
                                                                    title="Delete"
                                                                    class="btn btn-sm btn-link border border-0" style="width: 50px">
