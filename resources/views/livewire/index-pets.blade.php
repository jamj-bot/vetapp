                    ...
                    <tbody>
                        @forelse($pets as $pet)
                            <tr>
                                ...
                                <td>
                                    <a class="font-weight-bold btn-block text-warning"
                                        href="{{ route('admin.pets.show', $pet) }}">
                                        {{ $pet->name}}
                                    </a>
                                </td>
                                <td>
                                ...
                                <td>
                                    {{ $pet->species->name}} / <span class="font-italic text-muted">{{ $pet->species->scientific_name }}</span>
                                </td>
                            </tr>
                        @empty
